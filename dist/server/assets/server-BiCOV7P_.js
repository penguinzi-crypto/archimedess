...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DdxG73u6.js");
...
const manifest = {
  "014feeb62350dcb3c1604586a7c738d656d284d9ae4638c2346a9a2808166c31": {
    ...
    importer: () => import("./submissions.functions-CcrWrsO5.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B0ohDPEK.js").then((n) => n.r),
    import("./start-fM_zIqRi.js"),
